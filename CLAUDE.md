...
- Ship: THREE.Group containing GLB model (low-poly spaceship, 472 verts, 3 unlit materials) + 3 engine glow sprites; loaded via GLTFLoader with async cache, centered/normalized to unit size, scaled by CONFIG.ship.meshScale
